...
/**
 * Thrown when the configured storage backend (MongoDB, RocksDB, etc.) fails to perform
 * a requested operation. This is an unchecked exception; callers must not swallow it silently.
 */
public class StorageBackendException extends RuntimeException {
     ...
     *
     * @param message human-readable description of the failure
     * @param cause   the underlying exception from the storage backend
     */
